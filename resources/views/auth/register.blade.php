    ...
    <div class="auth_div vivify fadeInTop">
        <div class="card">
            <div class="body">
                ...
                <form method="POST" class="form-auth-small" action="{{ route('register') }}"  id="basic-form" novalidate>
                    ...
                    <div class="mt-4">
                        ...
                        <span class="text-center helper-text" >Already have an account?  <a href="{{route('login')}}">Login</a></span>
