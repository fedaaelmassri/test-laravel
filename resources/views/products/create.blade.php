    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <form method="POST" action="{{route('products.store')}}" id="basic-form" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group mb-4">
                                <label for="color_t" class="control-label"> Product Name</label>
                                <input value="{{old('name')}}" type="text" class="form-control @if ($errors->has('name'))is-invalid @endif" id="name" name="name" required>
                                @if ($errors->has('name'))
                        ...
                        <div class="col-lg-6 col-md-12"> 
                           ...
                           <input value="{{old('price')}}" type="number" class="form-control @if ($errors->has('price'))is-invalid @endif" id="price" name="price" required>
                                @if ($errors->has('price'))
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea rows="4" cols="50" value="" type="text" class="form-control  " id="details" name="details" required>  </textarea>
                    ...
                    <div class="col-lg-6  col-md-12">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <div class="custom-file">
                                <input name="image" type="file"   class="  @if ($errors->has('image'))is-invalid @endif " multiple="" id="image" required>
